...
public class UIFade : MonoBehaviour
{
    ...
    public delegate void ActionDelegate(UIFade fade);
    public event ActionDelegate onFadeInEvent;
    public event ActionDelegate onFadeOutEvent;
    ...
    public static UIFade CreateInstance(GameObject FadeObject, string name = "[UIFader]", bool hide = true)
    {
        ...
        {
            return FindObjectsOfType<UIFade>().SingleOrDefault(x => x.FadeObj == FadeObject);
        }
    }
