...
public class PlayerFunctions : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {
            if (crossPlatformInput.ActionExist("LeanLeft"))
            {
                LeanLeft = crossPlatformInput.GetInput<bool>("LeanLeft");
            }

            if (crossPlatformInput.ActionExist("LeanRight"))
            {
                LeanRight = crossPlatformInput.GetInput<bool>("LeanRight");
            }

            ZoomKey = crossPlatformInput.GetInput<bool>("Zoom");
        }
